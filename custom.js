 ...
 var contractAddress = "0x0710f1f272ffa3219952ce599ee6c08dc6c9ad53"; // in Ropsten testnet!
	...
	var deposit = 5000; //$('#greeting').val();
        contractInstance.depositEnergy(deposit, function(error, txHash) {
            ...
            $('#content').text('Thank you for signing up,  your transaction hash is: ' + txHash + ' - Please now go back to Dashboard: ' + '<a href="url">https://electriciteam.github.io/demo/dashboard</a>' );
        });
    });
